...
public class UserTest {
    ...
    public void test1() {
        ...
        Task task1 = new Task(1L, null, "Task 1", new Date(), new Date(), 1, TaskStatus.NOT_STARTED);
        Task task2 = new Task(2L, null, "Task 2", new Date(), new Date(), 1, TaskStatus.NOT_STARTED);
